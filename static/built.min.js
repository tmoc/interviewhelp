...
var selfEasyrtcid="",connect=function(){easyrtc.setRoomOccupantListener(convertListToButtons),easyrtc.easyApp("easyrtc.audioVideo","selfVideo",["callerVideo"],loginSuccess,loginFailure)},clearConnectList=function(){for(var e=document.getElementById("otherClients");e.hasChildNodes();)e.removeChild(e.lastChild)},convertListToButtons=function(e,n){clearConnectList();var t=document.getElementById("otherClients");for(var o in n){var c=document.createElement("button");c.onclick=function(e){return function(){performCall(e)}}(o);var i=document.createTextNode(easyrtc.idToName(o));c.appendChild(i),$(c).css({"background-color":"#ddd",cursor:"pointer"}),t.appendChild(c)}},performCall=function(e){easyrtc.hangupAll();var n=function(){$("#hangup").toggle()},t=function(){};easyrtc.call(e,n,t)},loginSuccess=function(e){selfEasyrtcid=e,document.getElementById("iam").innerHTML="My ID: "+easyrtc.cleanId(e)},loginFailure=function(e,n){easyrtc.showError(e,n)};$(function(){$("#questions").hide(),$("#hangup").hide(),connect(),$("#showquestions").click(function(){$("#connectControls").toggle(),$("#showquestions").toggle(),$("#questions").toggle()}),$("#hidequestions").click(function(){$("#connectControls").toggle(),$("#showquestions").toggle(),$("#questions").toggle()}),$("#hangup").click(function(){easyrtc.hangupAll(),$("#hangup").toggle()})});