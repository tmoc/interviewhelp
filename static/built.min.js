...
var selfEasyrtcid="",connect=function(){easyrtc.setRoomOccupantListener(convertListToButtons),easyrtc.easyApp("easyrtc.audioVideo","selfVideo",["callerVideo"],loginSuccess,loginFailure)},clearConnectList=function(){for(var e=document.getElementById("otherClients");e.hasChildNodes();)e.removeChild(e.lastChild)},convertListToButtons=function(e,t){clearConnectList();var n=document.getElementById("otherClients");for(var o in t){var c=document.createElement("button");c.onclick=function(e){return function(){performCall(e)}}(o);var i=document.createTextNode(easyrtc.idToName(o));c.appendChild(i),n.appendChild(c)}},performCall=function(e){easyrtc.hangupAll();var t=function(){},n=function(){};easyrtc.call(e,t,n)},loginSuccess=function(e){selfEasyrtcid=e,document.getElementById("iam").innerHTML="My ID: "+easyrtc.cleanId(e)},loginFailure=function(e,t){easyrtc.showError(e,t)};$(function(){$("#questions").hide(),connect(),$("#showquestions").click(function(){$("#connectControls").toggle(),$("#showquestions").toggle(),$("#questions").toggle()}),$("#hidequestions").click(function(){$("#connectControls").toggle(),$("#showquestions").toggle(),$("#questions").toggle()})});